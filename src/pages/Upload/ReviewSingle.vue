...
export default {
  ...
  computed: {
    ...mapState(['isWalletLoaded', 'singleInfoId', 'username', 'singleCoverFile', 'singleCoverRaw', 'singleCoverType', 'singleMusicType', 'singleInfo', 'uploadCoverPct', 'uploadMusicPct', 'singleUploadComplete', 'uploadStatus'])
  },
  watch: {
